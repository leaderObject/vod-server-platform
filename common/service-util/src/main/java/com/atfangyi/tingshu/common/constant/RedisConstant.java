package com.atfangyi.tingshu.common.constant;
...
public class RedisConstant {
    ...
    public static final String USER_ADMIN_LOGIN_KEY_PREFIX = "user:admin_login:";
    ...
    public static final String ADMIN_INFO_PREFIX = "adminInfo:";
