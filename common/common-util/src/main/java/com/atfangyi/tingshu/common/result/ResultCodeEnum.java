package com.atfangyi.tingshu.common.result;
...
public enum ResultCodeEnum {
    ...
    PHONE_CODE_MORE(215, "当日验证码发送次数过多"),
    PHONE_CODE_FAST(215, "验证码发送频繁"),
    LOGIN_MOBLE_ERROR(216, "账号不正确"),
    ACCOUNT_STOP(216, "账号已停用"),
    NODE_ERROR(217, "该节点下有子节点，不可以删除"),

    USER_PASSWORD_NOT_NULL(501, "账号或密码允许为空"),
    ...
    AUTH_ERROR(401, "请先登录"),
    PHONE_LOGIN_ERROR(401, "手机号登录出现 问题请联系管理员方毅"),
    PARAM_ERROR(501, "参数校验异常"), DATA_NULL(500,"数据为空" );
    ...
    public static ResultCodeEnum resultCodeEnum(Integer code) {
